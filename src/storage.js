const projects = [
  {
    title: 'Meal Recipe Catalogue',
    image: '',
    description:
      'This is a food recipe catalogue which helps users to conviniently prepare tasty home-made meals.',
  ...
  },
  {
    ...
    image: '',
    description: 'A site where consumers can post, vote & read on articles.',
  ...
  },
  {
    ...
    image: '',
    description:
      'This is a web-based game in which players need to dodge the falling bugs to survive and earn more points.',
  ...
  },
  {
    ...
    image: '',
    description:
      'A Web Scraper that takes information from Medium Website and displays it on the terminal.',
  ...
  },
  {
    ...
    image: '',
    description:
      'Need to do a quick Math? Use this fast and convenient web application from the browser of your choice.',
  ...
  },
  {
    ...
    image: '',
    description:
      ' It is an app for a Germany fictional company Magic Books Inc. The application helps organize and manage the company\'s bookstore.',
